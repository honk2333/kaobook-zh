...
\includepdf[pages=-, pagecommand={}]{封面.pdf}
...
\input{contents/1.introduction.tex}
\input{contents/2.technology.tex}

\pagelayout{wide} % No margins
\addpart{产业篇：智慧蔓延}
\pagelayout{margin} % Restore margins
\input{contents/4.industry.tex}
\input{contents/5.internet.tex}
% \input{contents/6.traffic.tex}
% \input{contents/7.medical.tex}
% \input{contents/8.financial.tex}

\pagelayout{wide} % No margins
\addpart{方法篇：智能之舞}
\pagelayout{margin} % Restore margins
% \input{contents/10.tendays.tex}

\pagelayout{wide} % No margins
\addpart{风险篇：智慧的边界}
\pagelayout{margin} % Restore margins
\input{contents/11.policy.tex}
\input{contents/12.ethics.tex}
